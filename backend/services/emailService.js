      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 20px;">
        ...
        <div style="margin-top: 32px; border-top: 1px solid #E5E7EB; padding-top: 20px; text-align: center;">
          <p style="color: #9CA3AF; font-size: 12px; margin: 0 0 10px 0;">
            🔒 Our full privacy policy is available on the login page.
          </p>
          <a href="${loginUrl}" style="color: #10B981; font-size: 12px; text-decoration: underline;">View Privacy Policy →</a>
          <p style="color: #D1D5DB; font-size: 11px; margin-top: 16px;">Service Portal · <a href="mailto:sameer@superstay.no" style="color: #D1D5DB;">sameer@superstay.no</a></p>
        </div>
      </div>
    `;
