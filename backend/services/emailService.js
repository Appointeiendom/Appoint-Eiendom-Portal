    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 20px;">
        ...
        <div style="margin-top: 32px; border-top: 1px solid #E5E7EB; padding-top: 20px;">
          <details>
            <summary style="cursor: pointer; color: #6B7280; font-size: 12px; font-weight: 600; user-select: none; list-style: none; display: flex; align-items: center; gap: 6px;">
              🔒 Privacy Policy ▼
            </summary>
            <div style="margin-top: 14px; font-size: 12px; color: #6B7280; line-height: 1.7;">
              <p style="color: #9CA3AF; font-size: 11px; margin: 0 0 14px 0; font-style: italic;">Last updated: 15 June 2026</p>
          ...
          <p style="color: #E5E7EB; font-size: 11px; margin-top: 16px; text-align: center;">Service Portal</p>
        </div>
      </div>
    `;
