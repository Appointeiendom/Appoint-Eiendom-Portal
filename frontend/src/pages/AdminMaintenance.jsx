    ...
    <Layout>
      <div className="max-w-5xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Maintenance Workers</h1>
            <p className="text-gray-500 text-sm mt-1">Manage your list of maintenance professionals</p>
          </div>
        ...
        {showForm && (
          <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
            <h2 className="font-semibold text-gray-700 mb-4">{editWorker ? 'Edit Worker' : 'Add New Worker'}</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button type="submit" disabled={submitting}
                  ...
                  {submitting ? 'Saving...' : editWorker ? 'Save Changes' : 'Add Worker'}
                </button>
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 rounded-xl p-12 text-center">
            <p className="text-gray-400 text-lg">No maintenance workers added yet.</p>
            <button onClick={openAdd} className="mt-4 text-emerald-600 hover:underline text-sm">Add your first worker →</button>
          </div>
        ) : (
