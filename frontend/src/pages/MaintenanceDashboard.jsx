  ...
  return (
    <Layout>
      <div className="max-w-2xl">
        ...
        <p className="text-gray-500 text-sm mb-6">Trade: {user?.trade || profile?.trade}</p>
        ...
        <div className="grid gap-4">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6">
            <h2 className="font-semibold text-gray-700 mb-1">Availability Calendar</h2>
            <p className="text-sm text-gray-500 mb-3">Keep your availability up to date so tenants know when you're free.</p>
            <a href="/maintenance/availability" className="inline-block bg-emerald-500 text-white text-sm px-4 py-2 rounded-lg hover:bg-emerald-600 transition-colors">
              Manage Availability →
            </a>
          </div>
        </div>
